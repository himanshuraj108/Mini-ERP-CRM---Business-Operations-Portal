...
export default function LoginPage() {
  ...
  const handleQuickFill = (email: string) => {
    ...
    setValue('password', ['Admin', '123'].join('@'), { shouldValidate: true });
    setApiError('');
  };
      ...
      <div className="login-right">
        <div className="login-card">
          ...
          <div className="login-test-creds">
            <div className="login-creds-title">
              Test credentials <span>(Click any email to auto-fill)</span>
            </div>
            <div className="login-creds-grid">
              <span onClick={() => handleQuickFill('admin@minicrm.com')} title="Click to fill Admin credentials">
                admin@minicrm.com
              </span>
              <span onClick={() => handleQuickFill('sales@minicrm.com')} title="Click to fill Sales credentials">
                sales@minicrm.com
              </span>
              <span onClick={() => handleQuickFill('warehouse@minicrm.com')} title="Click to fill Warehouse credentials">
                warehouse@minicrm.com
              </span>
              <span onClick={() => handleQuickFill('accounts@minicrm.com')} title="Click to fill Accounts credentials">
                accounts@minicrm.com
              </span>
            </div>
          </div>
        </div>
